...
U 1 1 58592D53
P 3600 2650
F 0 "#PWR0159" H 3600 2740 20  0001 C CNN
...
U 1 1 58592DBB
P 3600 5200
F 0 "#PWR0160" H 3600 5200 30  0001 C CNN
...
U 1 1 58594786
P 6200 3500
F 0 "#PWR0161" H 6200 3500 30  0001 C CNN
...
U 1 1 58594848
P 6200 5300
F 0 "#PWR0162" H 6200 5300 30  0001 C CNN
...
U 1 1 58594C14
P 10000 5400
F 0 "#PWR0163" H 10000 5400 30  0001 C CNN
...
$EndComp
$Comp
L GND-RESCUE-DFTBoard #PWR0164
U 1 1 58594C4F
P 10000 3500
F 0 "#PWR0164" H 10000 3500 30  0001 C CNN
...
U 1 1 585961DB
P 10000 2750
F 0 "#PWR0165" H 10000 2890 20  0001 C CNN
...
U 1 1 5859729A
P 6200 4600
F 0 "#PWR0166" H 6200 4560 30  0001 C CNN
...
U 1 1 5859769E
P 10000 4500
F 0 "#PWR0167" H 10000 4640 20  0001 C CNN
...
U 1 1 587421F0
P 6200 2750
F 0 "#PWR0168" H 6200 2600 50  0001 C CNN
...
U 1 1 5881191F
P 7250 2700
F 0 "#PWR0169" H 7250 2790 20  0001 C CNN
...
Wire Wire Line
	7250 2750 7500 2750
$Comp
L GND-RESCUE-DFTBoard #PWR0170
U 1 1 58811FEA
P 3600 3350
F 0 "#PWR0170" H 3600 3350 30  0001 C CNN
...
U 1 1 58813096
P 3600 4500
F 0 "#PWR0171" H 3600 4590 20  0001 C CNN
...
U 1 1 58813465
P 7250 3350
F 0 "#PWR0172" H 7250 3350 30  0001 C CNN
...
U 1 1 58813966
P 7250 5200
F 0 "#PWR0173" H 7250 5200 30  0001 C CNN
...
U 1 1 58813D02
P 7250 4500
F 0 "#PWR0174" H 7250 4590 20  0001 C CNN
...
U 1 1 58ABBBC2
P 2900 6400
F 0 "#PWR0175" H 2900 6150 50  0001 C CNN
...
U 1 1 58ABBBC8
P 2900 6950
F 0 "#PWR0176" H 2900 6700 50  0001 C CNN
